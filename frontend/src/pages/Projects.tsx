                    ...
                    >
                            ...
                            <div className="flex items-start justify-between mb-2">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        <DropdownMenuItem onClick={() => deleteProject(project.id)} className="text-destructive focus:text-destructive">
                                            Delete Project
                                        </DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                        ...
                        <div className="flex items-center justify-between text-xs text-muted-foreground mt-auto pt-4 border-t border-border/30">
                            ...
                            <div className="flex items-center gap-1.5">
                                ...
                                <span>Updated {format(new Date(project.updatedAt || project.createdAt), 'MMM d')}</span>
                            </div>
                        </div>
                    </div>
                ))}
