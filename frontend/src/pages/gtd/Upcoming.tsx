...
const UpcomingPage = () => {
    const { data: tasks = [], isLoading } = useTasks({ scope: 'upcoming' });
            ...
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Schedule and plan your future actions</p>
                    </div>
                </div>
            </motion.div>
            ...
            <div className="space-y-4">
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-3 text-muted-foreground">
                        ...
                        <p className="text-sm">Scanning horizons...</p>
                    </div>
                ) : tasks.length > 0 ? (
                    ...
                    <div className="bg-card/30 border border-dashed rounded-2xl p-20 text-center space-y-4">
                        ...
                        <div className="max-w-xs mx-auto space-y-2">
                            <h3 className="text-lg font-medium text-foreground">Quiet Calendar</h3>
